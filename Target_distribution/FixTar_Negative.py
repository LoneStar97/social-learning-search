...
numtar_per_pos_patch = 600 # number of targets/negative targets per positive patch
numtar_per_neg_patch = 300 # number of targets/negative targets per negative patch
num_p = 10 # number of patches
num_np = 20 # number of negative patches
targets = numtar_per_pos_patch*num_p # number of targets
neg_targets = numtar_per_neg_patch*num_np # number of negative targets
...
NumTar = 2000 # number of cases
hdf5_filename = str(num_p)+'P'+str(numtar_per_pos_patch)+'_'+str(num_np)+'NP'+str(numtar_per_neg_patch)+'.h5' # file name
